...
GRTensorII section, one can switch between them by using the \grcmd{grmetric}
...
previous versions of GRTensorII, the \grcmd{nptetrad} command required
...
GRTensorII previous to 1.50, the output of \grcmd{nptetrad} was in the
