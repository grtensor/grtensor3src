...
\end{center}
Here the \grarg{tensorSeq} is a sequence of GRTensorII objects each of
...
into GRTensorII using \grcmd{qload}, as described in Booklet \grMakegRef.\\
...
for GRTensorII operators. For such objects the \grcmd{grmetric} command
...
\begin{cmdspec}
  ...
  \begin{description}
    \item[\grarg{objectSeq}] -- A sequence of GRTensorII indexed object names.
  \end{description}
...
\begin{cmdspec}
  ...
  \begin{description}
    \item[\grarg{objectSeq}] -- A GRTensorII indexed object name, or sequence 
      of object names.
...
Unlike most other GRTensorII commands, \grcmd{grcomponent} returns a
